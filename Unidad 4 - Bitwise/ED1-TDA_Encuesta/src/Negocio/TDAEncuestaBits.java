...
public class TDAEncuestaBits {
  ...
  //  VectorNbits V4Hora;
    ...
    public TDAEncuestaBits(int cantidad) {
  ...
  /*  public int getSegundo(int pos)
    ...
    {
        TDAEncuestaBits A=new TDAEncuestaBits(10);
